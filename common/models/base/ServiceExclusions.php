...
/**
 * This is the base-model class for table "service_exclusions".
 *
 ...
 */
abstract class ServiceExclusions extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return ArrayHelper::merge(parent::attributeLabels(), [
            'exclusion_id' => Yii::t('app', 'Exclusion ID'),
